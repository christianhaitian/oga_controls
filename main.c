...
short left_analog_up = KEY_GRAVE;
short left_analog_down = KEY_GRAVE;
short left_analog_left = KEY_GRAVE;
short left_analog_right = KEY_GRAVE;
short right_analog_up = KEY_GRAVE;
short right_analog_down = KEY_GRAVE;
short right_analog_left = KEY_GRAVE;
short right_analog_right = KEY_GRAVE;
